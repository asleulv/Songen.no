...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # or your custom path
]
...
# Check if DJANGO_ENV is set to 'production' or 'development'
if os.getenv('DJANGO_ENV') == 'production':
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'NAME': os.getenv('MYSQL_DB', 'onesongdb'),
...
# Essential for Nginx Proxy Manager / SSL
